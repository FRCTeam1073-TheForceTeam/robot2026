...
const frc::Rectangle2d ZoneFinder::RIGHTHALF = frc::Rectangle2d(frc::Translation2d(0_in, 0_in), frc::Translation2d(650.12_in, 158.32_in));
const frc::Rectangle2d ZoneFinder::LEFTHALF = frc::Rectangle2d(frc::Translation2d(0_in, 158.32_in), frc::Translation2d(650.12_in, 316.64_in));
...
const frc::Rectangle2d ZoneFinder::RIGHTHALF = frc::Rectangle2d(frc::Translation2d(0_in, 0_in), frc::Translation2d(651.22_in, 158.84_in));
const frc::Rectangle2d ZoneFinder::LEFTHALF = frc::Rectangle2d(frc::Translation2d(0_in, 158.84_in), frc::Translation2d(651.22_in, 317.69_in));
